...
- [ ] **task-057**: Cover remaining `conditions.py` edge branches (88% → 92%+) — add tests for None-guard branches in gt/lt/eq ops (lines 273, 278, 295-296), file error paths (lines 342-345, 373-374), subprocess timeout/error handling (lines 504-512, 515-516, 532-544). ~10 targeted tests.
